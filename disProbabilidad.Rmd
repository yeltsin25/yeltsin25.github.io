---
title: <span style="color:#7D3C98">Distribución de probabilidad</span>
output:
  #pdf_document: default
  word_document: default
---

## <span style="color:#2980B9">¿Qué es una distribución de probabilidad?</span> 
...
##  <span style="color:#2980B9">Variable aleatoria</span>
...
## <span style="color:#2980B9">Media de una Distribución de Probabilidades</span>
...
## <span style="color:#2980B9">Varianza</span>

Mide el grado de dispersión de la distribución de probabilidades.\

# <span style="color:#A93226">Distribución Discreta</span>

## <span style="color:#2980B9">1. Distribución Binomial</span>
...
## <span style="color:#2980B9">2. Distribución hipergeométrica</span>
<div style="text-align: justify">
...
# <span style="color:#2980B9">3.Distribución de Poisson.</span>
<div style="text-align: justify">
...
```
# <span style="color:#C0392B">Distribución continua.</span>
<div style="text-align: justify">
...
## <span style="color:#2980B9">1. DISTRIBUCIÓN BETA</span>
<div style="text-align: justify">
...
## <span style="color:#2980B9">2. Distribución Gamma</span>
...
## <span style="color:#2980B9">3. Distribución Exponencial</span>
<div style="text-align: justify">
...
## <span style="color:#2980B9">4. Distribución Normal</span>
...
## <span style="color:#2980B9">5. Distribución t de Student</span>
