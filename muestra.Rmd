---
title: <span style="color:#7D3C98">DISTRIBUCIONES MUESTRALES</span>
output:
 # pdf_document: default
  word_document: default
---

# <span style="color:#A93226">1 Muestreo aleatorio</span>

## <span style="color:#2980B9">1.1 Población y parámetros</span>
...
## <span style="color:#2980B9">1.2 Muestra aleatoria</span>
<div style="text-align: justify">
...
## <span style="color:#2980B9">1.3 Estadísticas</span>
<div style="text-align: justify">
...
<div/>\
  ...
  $\text{d) La proporción muestral (porcentaje de éxitos en la muestra) } \bar{P}= \sum_{i=1}^{n}X_{i} \text{donde X¡ - fi(l, p)}$
  $\text{(el parámetro p es el porcentaje de éxitos en la población).También}$
  $$\bar{P}=\frac{X}{n}\text{, donde } \text{X ~B(n,p)} $$

\

## <span style="color:#A93226">2. Distribuciones muéstrales</span>
...
### <span style="color:#2980B9">2.1 Distribución muestral de la media $\bar{X}$</span>
